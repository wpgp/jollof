#' @title pyramid: making population pyramid of demographics
#'
...
#' considered.
#'
#' @return Data frames of the diaggregated population numbers along with uncertainty
#' for the age and sex groups or other demographic groups.
#'
#'@examples
#' \dontrun(result <- pyramid(female_pop,male_pop)
#' @export
#' @importFrom dplyr "%>%"
#'
